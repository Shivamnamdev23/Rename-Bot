...
async def start(client,message):
	...
	reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('⚚     ɱᴀɪɴ   ᴄʜᴀɴɴᴇʟ     ⚚', url='https://telegram.me/crazybotz')],[InlineKeyboardButton('👨‍💻   ᴏᴡɴᴇʀ', url='https://telegram.me/heartlesssn'),InlineKeyboardButton('🙏   ꜱᴜᴘᴘᴏʀᴛ', url='https://telegram.me/crazysupportz')],[InlineKeyboardButton('🍂   ʜᴇʟᴘ', callback_data = "khushi"),InlineKeyboardButton('📝   ᴀʙᴏᴜᴛ', callback_data = "upgrade")]]))
	    return
	if id:
	    if old == True:
	        try:
	            ...
	            await message.reply_text(text =f"""{message.from_user.mention},\nɪ  ᴀᴍ  ᴀɴ  ᴀᴅᴠᴀɴᴄᴇ  ꜰɪʟᴇ  ʀᴇɴᴀᴍᴇʀ  ᴀɴᴅ  ᴄᴏɴᴠᴇʀᴛᴇʀ  ʙᴏᴛ  ᴡɪᴛʜ  ᴘᴇʀᴍᴀɴᴇɴᴛ  ᴀɴᴅ  ᴄᴜsᴛᴏᴍ  ᴛʜᴜᴍʙɴᴀɪʟ  sᴜᴘᴘᴏʀᴛ.\n\nᴊᴜsᴛ  sᴇɴᴅ  ᴍᴇ  ᴀɴʏ  ᴠɪᴅᴇᴏ  ᴏʀ ᴅᴏᴄᴜᴍᴇɴᴛ !!""",reply_to_message_id = message.id ,  
	reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('ℵ    ɱᴀɪɴ   ᴄʜᴀɴɴᴇʟ    ℵ', url='https://telegram.me/crazybotz')],[InlineKeyboardButton('👨‍💻   ᴏᴡɴᴇʀ', url='https://telegram.me/heartlesssn'),InlineKeyboardButton('🙏   ꜱᴜᴘᴘᴏʀᴛ', url='https://telegram.me/crazysupportz')],[InlineKeyboardButton('🍂   ʜᴇʟᴘ', callback_data = "khushi"),InlineKeyboardButton('📝   ᴀʙᴏᴜᴛ', callback_data = "upgrade")]]))
	        except:
	             return
	    else:
